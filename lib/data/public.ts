...
function fallbackSiteSettings(): SiteSettingsRow {
  return {
    ...
    hero_eyebrow: "Accra — for shops, farms, schools, clinics, churches & offices",
    hero_subheading:
      "Websites, records & receipts, business equipment, and IT support — set up in person by a team that comes to you.",
    hero_microcopy: "No jargon. No trip to an office.",
    hero_cta_primary_label: "Get a free assessment",
    hero_cta_whatsapp_label: "Chat on WhatsApp",
    about_hero_image_url: null,
    services_hero_image_url: null,
    hardware_hero_image_url: null,
